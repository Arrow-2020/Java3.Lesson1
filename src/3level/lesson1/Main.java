...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        3level.lesson1.Box<3level.lesson1.Orange> or = new 3level.lesson1.Box<>();
        3level.lesson1.Box<3level.lesson1.Orange> or1 = new 3level.lesson1.Box<>();
        3level.lesson1.Box<3level.lesson1.Apple> ap = new 3level.lesson1.Box<>();
        3level.lesson1.Box<3level.lesson1.Apple> ap1 = new 3level.lesson1.Box<>();
        System.out.println("Task3");
        System.out.println("'g' - addFruit: ");
        or.addFruit(new 3level.lesson1.Orange(),10);
        or1.addFruit(new 3level.lesson1.Orange(),12);
        ap.addFruit(new 3level.lesson1.Apple(),8);
        ap1.addFruit(new 3level.lesson1.Apple(),4);
